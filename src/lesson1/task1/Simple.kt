...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double =
    (sagenes * 48.000 + arshins * 16.000 + vershoks) * 4.445 / 100.000
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    var summaWhithPersent = initial.toDouble()
    for (x in 1..3) {
        summaWhithPersent += (summaWhithPersent * percent / 100.00)
    }
    return summaWhithPersent
}
